	...
	public class LeaveRequestRepository : GenericRepository<LeaveRequest>, ILeaveRequestRepository
	{
		...
		public async Task ChangeApprovalStatus(int leaveRequestId, bool approved)
		{
			...
			if (approved)
			{
				...
				var allocation = await leaveAllocationRepository.GetEmployeeAllocation(leaveRequest.RequestingEmployeeId);
				...
				await leaveAllocationRepository.UpdateAsync(mapper.Map<LeaveAllocation>(allocation));
			}
		...
		public async Task<AdminLeaveRequestsViewVM> GetAdminLeaveRequestList()
		{
			...
			var model = new AdminLeaveRequestsViewVM
			{
				...
				ApprovedReqeusts = leaveRequests.Count(q => q.Approved == true),
