...
namespace LeaveManagement.Web.Controllers
{
    public class LeaveRequestsController : Controller
    {
        ...
        //public async Task<IActionResult> Create([Bind("LeaveTypeId,StartDate,EndDate,Cancelled,Approved,DateRequested,RequestComments,RequestingEmployeeId,Id,DateCreated,DateModified")] LeaveRequest leaveRequest)
